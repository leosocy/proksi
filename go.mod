...
replace (
	...
	golang.org/x/net v0.0.0-20190311183353-d8887717615a => github.com/golang/net v0.0.0-20190501004415-9ce7a6920f09
)
...
replace (
	golang.org/x/sys v0.0.0-20180906133057-8cf3aee42992 => github.com/golang/sys v0.0.0-20190429190828-d89cdac9e872
	golang.org/x/sys v0.0.0-20190403152447-81d4e9dc473e => github.com/golang/sys v0.0.0-20190429190828-d89cdac9e872
)

replace golang.org/x/tools v0.0.0-20180917221912-90fa682c2a6e => github.com/golang/tools v0.0.0-20190501045030-23463209683d
